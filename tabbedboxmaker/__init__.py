...
class BoxMaker(inkex.Effect):
    ...
    def render_side_side(
        ...
        sidePath = self.newLinePath('', side.line_thickness, idPrefix="side")
    ...
    def render_side_slots(
        ...
        for dividerNumber in range(1, int(numDividers) + 1):
            ...
            h.append(Line(Dx, Dy))
            h.append(ZoneClose())
            nodes.append(self.newLinePath(h, side.line_thickness, idPrefix="slot"))
        ...
        for tabDivision in range(1, int(divisions)):
            ...
            if (((tabDivision % 2) > 0) != (not isMale)) and numDividers > 0 and not isDivider:
                ...
                for dividerNumber in range(1, int(numDividers) + 1):
                    ...
                    h.append(Line(Dx, Dy))
                    h.append(ZoneClose())
                    nodes.append(self.newLinePath(h, side.line_thickness, idPrefix="hole"))
