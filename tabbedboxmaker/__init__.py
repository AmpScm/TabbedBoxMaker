            ...
            if idx == 0:
                ...
                for n in range(0, divx):  # generate X dividers
                    ...
                    side(group,
                         ...
                         0,
                         0)          # side a
                    side(group, (x + dx, y), (-b, a), (-b, -c), keydivwalls * btabs * (thickness if b else -
                         # side b
                                                                                       thickness), atabs, dy, (0, 1), b, 1, divy * xholes, xspacing)
                    side(group, (x + dx, y + dy), (-b, -c), (d, -c), keydivfloor * ctabs *
                         # side c
                         (thickness if c else -thickness), btabs, dx, (-1, 0), c, 1, 0, 0)
                    side(group, (x, y + dy), (d, -c), (d, a), keydivwalls * dtabs *
                         # side d
                ...
                for n in range(0, divy):  # generate Y dividers
                    ...
                    side(group,
                         ...
                         divx * yholes,
                         yspacing)          # side a
                    side(group, (x + dx, y), (-b, a), (-b, -c), keydivfloor * btabs *
                         # side b
                         (thickness if b else -thickness), atabs, dy, (0, 1), b, 1, 0, 0)
                    side(group, (x + dx, y + dy), (-b, -c), (d, -c), keydivwalls * ctabs *
                         # side c
                         (thickness if c else -thickness), btabs, dx, (-1, 0), c, 1, 0, 0)
                    side(group, (x, y + dy), (d, -c), (d, a), keydivfloor * dtabs *
                         # side d
                         (-thickness if d else thickness), ctabs, dy, (0, -1), d, 1, 0, 0)
