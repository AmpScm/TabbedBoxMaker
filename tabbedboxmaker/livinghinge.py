...
class LivingHinge(inkex.Effect):
    ...
    def box(self, a1, a2, leaveLeftSideOpen = False):
        """
    ...
    def LivingHinge2(self, a1, a2, space = 2, solidGap = 4):
        """
        ...
        if horizontalSlots%2: horizontalSlots-=1   # make it even so you end with an interior slot
    ...
    def effect(self):
        ...
        thickness = float(self.svg.unittouu( str(self.options.thickness)  + unit ))
